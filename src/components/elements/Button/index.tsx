export const Button: React.FC<ButtonProps> = ({
  ...
  if (style === "primary") {
    return (
      <button className={`h-10 px-4 py-2 bg-gradient-to-b from-violet-400 to-purple-800 hover:bg-gradient-to-b hover:from-purple-300 hover:to-violet-400 rounded-[40px] justify-center items-center gap-2.5 inline-flex ${extendClassName}`}>
    ...
    return (
      <button className={`h-10 px-4 py-2 rounded-[40px] border-2 border-violet-400 hover:border-violet-200 justify-center items-center gap-2.5 inline-flex ${extendClassName}`}>
