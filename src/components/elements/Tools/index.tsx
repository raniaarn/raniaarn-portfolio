...
export const Tools = () => {
  ...
  return (
    <div className='flex flex-col gap-8 md:gap-16 justify-center items-center pt-8'>
      <div className="grid grid-cols-3 md:grid-cols-6 gap-8 md:gap-16">
      ...
      {isMobile ?
        (<>
          <div className="grid grid-cols-3 md:grid-cols-5 gap-8 md:gap-16 justify-items-center">
