...
export const EVENTS = [
  {
    ...
    descriptions: [
      "Developed a comprehensive design system and crafted web designs for the Rumbel BEM UI 18 website, an education website for elementary school students.",
      "This project was in collaboration with team of 3 UI/UX designers, a product manager, and handoff designs to software engineers."
    ],
    childs: [
      {
        descriptions: "Created a design system for the website in collaboration with 2 other UI/UX Designers. The components I designed include buttons, cards, modals, accordions, and input fields.",
        imageUrls: "/images/organization/rumbel_ds.png",
        imageSize: ''
      },
      {
        descriptions: "After completing the design system, the requirements were approved by the stakeholders, including our department manager and product manager. We then discussed the user flow. The pages I created include an announcements section with CRUD functionality and a read-only profile page for mentors and instructors.",
        imageUrls: "/images/organization/rumbel_ui.png",
        imageSize: ''
      },
    ]
  },
