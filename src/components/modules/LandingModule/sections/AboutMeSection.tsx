...
export const AboutMeSection = () => {
  ...
  return (
    <div id='home-header' className={`pt-32 px-4 md:pt-40`}>
      <div className='flex-col my-auto md:flex-row flex mx-8 md:mx-20 items-end gap-4'>
        <div className='flex-col flex items-center md:items-start w-full h-full gap-2'>
          ...
          <p className='text-white text-sm mx-4 pb-4 md:mr-24 md:mx-auto xl:mx-0 text-justify pt-2'>
